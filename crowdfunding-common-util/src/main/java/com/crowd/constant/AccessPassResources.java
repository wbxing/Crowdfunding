...
public class AccessPassResources {
    ...
    static {
        ...
        PASS_RES_SET.add("/auth/member/sent/short/message.json");
    }
     ...
     *
     * @param servletPath 访问路径
     * @return true：是静态资源<p> false：不是静态资源
     */
    public static boolean isStaticResource(String servletPath) {
        ...
        // 根据 / 拆分ServletPath 字符串
        String[] split = servletPath.split("/");
        // 考虑到第一个斜杠左边经过拆分后得到一个空字符串是数组的第一个元素
        // 所以需要使用下标 1 取第二个元素
